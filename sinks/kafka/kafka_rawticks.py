...
import pandas as pd
from configs import KAFKA_TOPIC_RAW_TICKS, KAFKA_TOPIC_RAW_TICKS_TEST
...
class KafkaRawTicksSink(KafkaSinkBase):
    ...
    def process_fetched_data(self, products, start_datetime, end_datetime):
        ...
        final_dict = {}
        processed_df["Timestamp"] = processed_df["Timestamp"].astype("int64")
