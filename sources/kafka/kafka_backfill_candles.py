...
from configs import KAFKA_TOPIC_BACKFILL_CANDLES

class KafkaBackfillCandlesSource(KafkaSourceBase):
    """Class for handling kafka-based data fetch"""
    def __init__(self, start_date, end_date, products):
        super().__init__(KAFKA_TOPIC_BACKFILL_CANDLES, start_date, end_date, products)
