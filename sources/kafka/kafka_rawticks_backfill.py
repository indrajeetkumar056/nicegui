...
from configs import KAFKA_TOPIC_RAW_TICKS_BACKFILL

class KafkaRawTicksBackfillSource(KafkaSourceBase):
    """Class for handling Kafka-based data fetch"""
    def __init__(self, start_date, end_date, products):
        super().__init__(KAFKA_TOPIC_RAW_TICKS_BACKFILL, start_date, end_date, products)
