...
from configs import KAFKA_TOPIC_DESERIALIZED

class KafkaDeserializedSource(KafkaSourceBase):
    """Class for handling kafka-based data fetch"""
    def __init__(self, start_date, end_date, products):
        super().__init__(KAFKA_TOPIC_DESERIALIZED, start_date, end_date, products)
